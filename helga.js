...
const otod = "62882000563489@s.whatsapp.net"
...
Ayaa BOT merupakan project bot WhatsApp yang menggunakan Rdp, dijalankan menggunakan engine nodejs v14.0.0
...
case 'nsfw':
			...
			if (!isOwner && !isGroupAdmins) return reply(mess.only.admin)
					...
					if (Number(args[0]) === 1) {
						...
						helga.sendMessage(from, `Ayaa cantiii :v`, text)
