/* SCRIPT BY © Foxzy X Paw Botz!!
BASE : DENIS

NO HILANGIN CREATOR!!
JANGAN PERJUAL BELIKAN SC INI!!
TQ TO
- HELGA
- DENIS
- RUIN FF
...
//const { yta, ytv, buffer2Stream, ytsr, baseURI, stream2Buffer, noop } = require('./lib/ytdl.js')
...
const dtod = "6281386383559@s.whatsapp.net"
const otod = "6281386383559@s.whatsapp.net"
...
const ofrply1 = fs.readFileSync('./fake.png')
...
try {
		...
		const katalog = (teks) => {
             res = helga.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© Foxzy X Paw Botz_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             helga.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = helga.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6281386383559-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/IlpQRKWDZed0GgVHmYJUbl', "groupName": `${NamaBot}`, "footerText": "*_© Foxzy X Paw Botz_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
await helga.setStatus(`⛾ FoxzyXPaw || ⏳ Runtime: ${uptime} || 🎧 Uptime: ${kyun(os.uptime())}`).catch((_) => _);
...
const daftar1 = `Hai kak  ${pushname} ${tampilUcapan} \n\nSebelum Mengakses Bot Verify Terlebih Dahulu Ya, TTD FOXZY PAW`
const daftar2 = '```Ketik Tombol Di Bawah Untuk Mendaftar Ke Database © Foxzy X Paw Botz```'
...
helga.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© © Foxzy X Paw Botz_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		// GAME 
             game.cekWaktuFam(helga, family100)
        ...
        if (game.isfam(from, family100)) {
            ...
            if (anjuy.length < 1){
                helga.sendMessage(from, `Semua jawaban sudah tertebak\nKirim *${prefix}family100* untuk bermain lagi`, text)
		...
		const reply = (teks) => {
			helga.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${week} ${weton} - ${calender}`,body:"DON'T CLICK HERE",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/6281386383559`}}})
		}
		const simir = (teks) => {
		...
		const sticOwner = (hehe) => {
			...
			helga.sendMessage(hehe, ano, sticker, { quoted: mek})
		}
      ...
      if (budy.length > 2500) {
        ...
        if (budy.includes("wa.me/","https://wa.me//","https://wa.me/")) {
        	if (!mek.key.fromMe){
			    ...
			    helga.groupRemove(from, [kic]).catch((e) => { sticNotAdmin(from) })
            }
        }
			// MUTE
        if (isMuted){
        ...
        if (budy.includes("https://chat.whatsapp.com/")) {
			...
			helga.sendMessage(from, ano, sticker, { quoted: mek})
                      }
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_© Foxzy X Paw Botz_*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('http://instagram.com/foxzywashere')
}
if(isButton == 'ytm'){
reply('https://www.youtube.com/channel/UCNdRrmmOqNbxDrp85USLXig')
}
...
⚠️ Segala kebijakan dan ketentuan F O X Z Y P A W  B o T z di pegang oleh owner dan segala perubahan kebijakan, sewaktu waktu owner berhak mencabut, memblokir user(*﹏*) 

Arigatou Gozaimasu! Untuk kalian user ramah dan Beberapa orang yg ikut membantu juga dalam project pembuatan © Foxzy X Paw Botz-
😖🙏

For GitHub : https://github.com/foxzyganzz
YouTube Foxzy : https://www.youtube.com/channel/UCNdRrmmOqNbxDrp85USLXig
`
sendButLocation(from, `${menu}`, "*_©F O X Z Y P A W  B o T z_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`ping`,buttonText:{displayText:'SPEED BOT'},type:1},{buttonId:`store`,buttonText:{displayText:'SEWABOT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
listMsg = {
 buttonText: `F O X Z Y P A W  B o T z`,
 footerText: '',
 description: `Foxzy`,
 sections: [
                     {
...
if (!args[0]) {
helga.sendMessage(from, listMsg, MessageType.listMessage, {contextInfo: { mentionedJid: [sender]}})
} else {
  helga.sendMessage(`${args[0]}@s.whatsapp.net`, listMsg, MessageType.listMessage, {contextInfo: { mentionedJid: [sender]}})
}
            break
            case 'quotes':
            ini_result = await fetchJson('https://api.lolhuman.xyz/api/random/quotesnime?apikey=${lolkey}')
  ...
  if (!isRegistered) return reply(`daftar dlu om ketik .verify`)
        ptod = "6281386383559@s.whatsapp.net"
        stod = `${sender}`
        uwu = '```'
...
_⫹⫺⏰Expired Prem : Not Premium_
_⫹⫺🧸Nama : ${pushname}_
_⫹⫺📬Bio User : ${stst}_
_⫹⫺🧰Nomor : @${stod.split('@')[0]}_


    ❏ *「 F O X Z Y P A W  B o T z 」* ❏

_⫹⫺🍥Library : Baileys-script_
_⫹⫺🍰Version : 1.0.9_
_⫹⫺🍧Language : Javascript_
_⫹⫺🍑Author : © Foxzy X Paw_
_⫹⫺💬Time : ${timeWib} WIB_
...
╰─────
`
sendButLocation(from, `${menu}`, `${uwu}F O X Z Y P A W  B o T z${uwu}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}store1`,buttonText:{displayText:'STORE'},type:1},{buttonId:`${prefix}info1`,buttonText:{displayText:'INFO RULES'},type:1},{buttonId:`${prefix}store2`,buttonText:{displayText:'LIST NOKOS/JUALAN'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
        /*case 'help':
  case 'menu':
...
⛾Website : https://foxzywashere.my.id/
...
🕗 Wita : ${timeWita}
🕣 Wit : ${timeWit}`
sendButLocation(from, `${menu}`, `F O X Z Y P A W  B o T z`, {jpegThumbnail:ofrply1}, [{buttonId:`${prefix}owner`,buttonText:{displayText:'OWNER'},type:1},{buttonId:`${prefix}store`,buttonText:{displayText:'SEWA BOT'},type:1},{buttonId:`${prefix}script`,buttonText:{displayText:'SCRIPT🌹'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break*/
case 'menu':
        case 'help':
...
🕗 Wita : ${timeWita}
🕣 Wit : ${timeWit}`
sendButLocation(from, `${menu}`, `${uwu}F O X Z Y P A W  B o T z${uwu}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}allmenu`,buttonText:{displayText:'MENU ALL📒'},type:1},{buttonId:`${prefix}owner`,buttonText:{displayText:'OWNER👤'},type:1},{buttonId:`${prefix}bm`,buttonText:{displayText:'SIMPLE MENU📊'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case 'bm':
 listMsg = {
 buttonText: 'KLIK DISINI',
 footerText: '*SUPPORT F O X Z Y P A W  B o T z.ೃ࿐*',
 ...
 rows: [
                          {
                              "title": "BOTMENU 📋 \n\n _SCRIPT F O X Z Y P A W  B o T z.ೃ࿐_",
                              "rowId": ""
                           },
                           {
                              "title": "STORE 🛒\n\n _SCRIPT F O X Z Y P A W  B o T z.ೃ࿐_",
...
break
case 'wait':
helga.sendMessage(from, `*HAI ${pushname} Daripada Nunggu Mending Subscribe Dulu*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "SUPPORT F O X Z Y P A W  B o T z.ೃ࿐",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./helga.jpg'),sourceUrl:"https://www.youtube.com/channel/UCNdRrmmOqNbxDrp85USLXig"}}})
break
case 'success':
helga.sendMessage(from, `*Success Jangn Lupa Subscribe*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "SUPPORT F O X Z Y P A W  B o T z.ೃ࿐",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./helga.jpg'),sourceUrl:"https://www.youtube.com/channel/UCNdRrmmOqNbxDrp85USLXig"}}})
break
case 'qr':
helga.sendMessage(from, `TEST`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "QR GOPAY",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./helga.jpg'),sourceUrl:"https://l.top4top.io/p_2226w1xbi1.jpg"}}})
break
////------------------------𝙰𝚢𝚊𝚊 𝚅2.ೃ࿐
        case 'store':
        stod = `${sender}`
...
├ _Info Nomor : Undefined_
│
└───「 \`\`\`${NamaBot}\`\`\` 」`
sendButLocation(from, `*_Hay ${pushname}_ 🌹*\n\nBerikut list menu yang tersedia di ${NamaBot}`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}listdm`,buttonText:{displayText:'📋 LIST DIAMOND/NOKOS/ALL'},type:1},{buttonId:`${prefix}member`,buttonText:{displayText:'💳 MEMBERSHIP'},type:1},{buttonId:`${prefix}info`,buttonText:{displayText:'❗ INFO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'info':
        case 'pwoww':
        stod = `${sender}`
...
│
└───「 \`\`\`${NamaBot}\`\`\` 」`
sendButLocation(from, `*❗ INFO*\n\nWaktu Buka Jam 09:00 - 22:00`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}gw1`,buttonText:{displayText:'👥 GRUB'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
//sewa bot
/*case 'premium': 
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
  if (args[0] === 'add') {
 if (helga.message.extendedTextMessage != undefined) {
mentioned = helga.message.extendedTextMessage.contextInfo.mentionedJid
...
case 'sewa':
       ...
       menu = `0`
sendButLocation(from, `*_Hai ${pushname} 🌹_* \n\nyakin nih mau sewa bot ? 🤔 Boong auto banned >_<`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}sewa1`,buttonText:{displayText:'💞Ya'},type:1},{buttonId:`${prefix}gk`,buttonText:{displayText:'👀Tidak'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'gc':
        case '0':
        stod = `${sender}`
       ...
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🥰\n\nSilahkan pilih ingin buka / tutup grub`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}opengc`,buttonText:{displayText:'BUKA'},type:1},{buttonId:`${prefix}closegc`,buttonText:{displayText:'TUTUP'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'sewa1':
 listMsg = {
 buttonText: 'KLIK DISINI',
 footerText: '*_© Foxzy X Paw Botz.ೃ࿐_*',
...
case '🕔sewa':
       ...
       menu = `0`
sendButLocation(from, `_*Hai ${pushname}🌹*_\n\nSilahkan pilih metode pembayaran`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}py`,buttonText:{displayText:'NOMOR 📱'},type:1},{buttonId:`${prefix}qrsewa`,buttonText:{displayText:'QR CODE 📱'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'py':
        case '0':
        stod = `${sender}`
       ...
       menu = `0`
sendButLocation(from, `_*Hai ${pushname}🌹*_\n\nSilahkan pilih metode pembayaran`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}o1`,buttonText:{displayText:'OVO 📱'},type:1},{buttonId:`${prefix}d1`,buttonText:{displayText:'GOPAY 📱'},type:1},{buttonId:`${prefix}d1`,buttonText:{displayText:'DANA 📱'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'qrsewa':
        case '0':
        stod = `${sender}`
       ...
       menu = `0`
sendButLocation(from, `_Hai ${pushname}🌹_\n\nSilahkan pilih metode pembayaran`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}qrg1`,buttonText:{displayText:'QR GOPAY 📱'},type:1},{buttonId:`${prefix}qro1`,buttonText:{displayText:'QR OVO 📱'},type:1},{buttonId:`${prefix}qrd1`,buttonText:{displayText:'QR DANA 📱'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'qro1':
helga.sendMessage(from, `*[❗] OPEN SEWA BOT*
╭───────────────
│ *Harga Sewa MINGGUAN*
│ 1 minggu : Rp 3.000 
│ 2 minggu : Rp 5.000
...
*════〘 ${NamaBot} 〙════*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "QRCODE OVO",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./helga.jpg'),sourceUrl:"https://l.top4top.io/p_2226w1xbi1.jpg"}}})
break
case 'qrg1':
helga.sendMessage(from, `*[❗] OPEN SEWA BOT*
╭───────────────
...
*════〘 ${NamaBot} 〙════*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "QRCODE GOPAY",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./helga.jpg'),sourceUrl:"https://l.top4top.io/p_2226w1xbi1.jpg"}}})
break
case 'qrg1':
helga.sendMessage(from, `*[❗] OPEN SEWA BOT*
╭───────────────
...
*════〘 ${NamaBot} 〙════*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "QRCODE DANA",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./helga.jpg'),sourceUrl:"https://l.top4top.io/p_2226w1xbi1.jpg"}}})
break
case 'o1':
menu = `*[❗] OPEN SEWA BOT*
╭───────────────
...
case 'sewaff2':
       ...
       menu = `0`
sendButLocation(from, `_Hai ${pushname}_\n\nSilahkan pilih metode pembayaran`, "_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}sewa2`,buttonText:{displayText:'💞Ya'},type:1},{buttonId:`${prefix}gk`,buttonText:{displayText:'👀Tidak'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
//𝙰𝚢𝚊𝚊 𝚅2.ೃ࿐
//𝙰𝚢𝚊𝚊 𝚅2.ೃ࿐
//𝙰𝚢𝚊𝚊 𝚅2.ೃ࿐
...
case 'donasi':
       ...
       menu = `0`
sendButLocation(from, `*_Hai ${pushname} 🌹_* \n\nyakin nih mau donasi ? 🤔 Boong auto banned >_<`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}donasi1`,buttonText:{displayText:'💞Ya'},type:1},{buttonId:`${prefix}gk`,buttonText:{displayText:'👀Tidak'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
//𝙰𝚢𝚊𝚊 𝚅2.ೃ࿐
case 'donasi1':
        case '0':
       ...
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🌹\n\n Silahkan pilih mau donasi via apa`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}qrdonasi`,buttonText:{displayText:'QR CODE 📱'},type:1},{buttonId:`${prefix}donasi111`,buttonText:{displayText:'NOMOR 📱'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'qrdonasi':
        case '0':
        stod = `${sender}`
...
case 'donasi111':
       ...
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 🌹\n\n Silahkan pilih mau donasi via apa`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}11`,buttonText:{displayText:'OVO 💸'},type:1},{buttonId:`${prefix}111`,buttonText:{displayText:'DANA 💸'},type:1},{buttonId:`${prefix}1111`,buttonText:{displayText:'GOPAY 💸'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
//𝙰𝚢𝚊𝚊 𝚅2.ೃ࿐
//𝙰𝚢𝚊𝚊 𝚅2.ೃ࿐
//𝙰𝚢𝚊𝚊 𝚅2.ೃ࿐
...
//𝙰𝚢𝚊𝚊 𝚅2.ೃ࿐
case 'qrovodonasi':
helga.sendMessage(from, `Sedekah bukan menjadikan seorang Muslim menjadi miskin tetapi malah menjadikan kaya raya. Hal ini sesuai dengan ayat tentang sedekah dan infaq dalam Quran surat Al Baqarah ayat 276 yang berbunyi
...
/// Okta cantipp
case 'botmenu':
sendButLocation(from, `${NamaBot}`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}list1`,buttonText:{displayText:'MENU 1📋'},type:1},{buttonId:`${prefix}list2`,buttonText:{displayText:'MENU 2📋'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
/// Okta cantipp
/// Okta cantipp
case 'list1':
...
case '70💎':
       ...
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 70 diamond dengan harga IDR 10.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay1`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '100💎':
        case '0':
        stod = `${sender}`
       ...
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 100 diamond dengan harga IDR 15.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay2`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '140💎':
        case '0':
        stod = `${sender}`
       ...
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 140 diamond dengan harga IDR 20.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay3`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '210💎':
        case '0':
        stod = `${sender}`
       ...
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 210 diamond dengan harga IDR 30.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay4`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '355💎':
        case '0':
        stod = `${sender}`
       ...
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 355 diamond dengan harga IDR 50.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay5`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '500💎':
        case '0':
        stod = `${sender}`
       ...
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 500 diamond dengan harga IDR 70.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay6`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '720💎':
        case '0':
        stod = `${sender}`
       ...
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 720 diamond dengan harga IDR 100.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay7`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '1000💎':
        case '0':
        stod = `${sender}`
       ...
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 1000 diamond dengan harga IDR 140.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay8`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '1215💎':
        case '0':
        stod = `${sender}`
       ...
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 1215 diamond dengan harga IDR 167.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay9`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '2005💎':
        case '0':
        stod = `${sender}`
       ...
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 2005 diamond dengan harga IDR 270.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay10`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '4005💎':
        case '0':
        stod = `${sender}`
       ...
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli 4005 diamond dengan harga IDR 535.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay11`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '💳mingguan':
        case '0':
        stod = `${sender}`
       ...
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli M.MINGGUAN dengan harga IDR 30.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay12`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case '💳bulanan':
        case '0':
        stod = `${sender}`
       ...
       menu = `0`
sendButLocation(from, `*_Hay ${pushname}_* 😄\n\n•Pilih payment jika ingin membeli M.BULANAN dengan harga IDR 117.000\n•Pilih back jika ingin kemabli ke list menu`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}topup`,buttonText:{displayText:'⬅️ BACK'},type:1},{buttonId:`${prefix}pay13`,buttonText:{displayText:'💸 PAYMENT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
//ini pembayaran ny//
break
case 'pay1':
...
//menu web
/*case 'ownermenu':
helga.sendMessage(from, `*HAI ${pushname}🌹*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "👨‍💻OWNER MENU👨‍💻",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./helga.jpg'),sourceUrl:"https://bit.ly/OwnerMenu"}}})
break
case 'othermenu':
helga.sendMessage(from, `*HAI ${pushname}🌹*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "👦OTHER MENU👦",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./helga.jpg'),sourceUrl:"https://bit.ly/OtherMenu"}}})
break
case 'groupmenu':
helga.sendMessage(from, `*HAI ${pushname}🌹*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "👥GROUP MENU👥",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./helga.jpg'),sourceUrl:"https://bit.ly/GroupMenu12"}}})
break
case 'makermenu':
helga.sendMessage(from, `*HAI ${pushname}🌹*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "🖍️ MAKER MENU🖍️",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./helga.jpg'),sourceUrl:"https://bit.ly/MakerMenu"}}})
break
case 'downloadmenu':
helga.sendMessage(from, `*HAI ${pushname}🌹*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 DOWNLOAD MENU📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./helga.jpg'),sourceUrl:"https://bit.ly/DownloadMenu1"}}})
break*/
case 'listdm':
helga.sendMessage(from, `*${pushname}🌹*\n\nSebelum Top Up Kirim Id Dulu Dengan Cara Ketik *${prefix}id*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "HAI🌹",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./helga.jpg'),sourceUrl:"https://www.youtube.com/channel/UCNdRrmmOqNbxDrp85USLXig"}}})
break
case 'member':
helga.sendMessage(from, `*${pushname}🌹*\n\nSebelum Top Up Kirim Id Dulu Dengan Cara Ketik *${prefix}uid*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "HAI🌹",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./helga.jpg'),sourceUrl:"https://www.youtube.com/channel/UCNdRrmmOqNbxDrp85USLXig"}}})
break
case 'id':
					if (!c) return reply(`ID Nya Mana Kak?\nContoh :\n${prefix}id 123456789`)
					atetepe = await getBuffer(`https://wa.me/6281386383559?text=Assalamualaikum${encodeURIComponent(c)}`)
					sendButLocation(from, `Nama : _${pushname}_\nNomor : _${stod.split('@')[0]}_\nID : _${encodeURIComponent(c)}_`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}listdm1`,buttonText:{displayText:'NEXT ➡️'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
					break
case 'uid':
					if (!c) return reply(`ID Nya Mana Kak?\nContoh :\n${prefix}uid 123456789`)
					atetepe = await getBuffer(`https://wa.me/6281386383559?text=Assalamualaikum${encodeURIComponent(c)}`)
					sendButLocation(from, `Nama : _${pushname}_\nNomor : _${stod.split('@')[0]}_\nID : _${encodeURIComponent(c)}_`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}member1`,buttonText:{displayText:'NEXT ➡️'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
					break
case 'qrcodeovo':
helga.sendMessage(from,`*HAI ${pushname}🌹*\n\n• Scan Qrcode Diatas\n• Isi Nominal Sesuai Pilihan\n• Transfer Sesuai Nominal`, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE OVO 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./payment.jpeg'),sourceUrl:"https://l.top4top.io/p_2226w1xbi1.jpg"}}})
break
case 'qrcodedana':
helga.sendMessage(from,`*HAI ${pushname}🌹*\n\n• Scan Qrcode Diatas\n• Isi Nominal Sesuai Pilihan\n• Transfer Sesuai Nominal`, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE DANA 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./payment.jpeg'),sourceUrl:"https://l.top4top.io/p_2226w1xbi1.jpg"}}})
break
case 'qrcodegopay':
helga.sendMessage(from`*HAI ${pushname}🌹*\n\n• Scan Qrcode Diatas\n• Isi Nominal Sesuai Pilihan\n• Transfer Sesuai Nominal`, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE GOPAY 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./payment.jpeg'),sourceUrl:"https://l.top4top.io/p_2226w1xbi1.jpg"}}})
break
/*case 'sewa1':
               list = []
...
case 'waktu':
            ...
            helga.sendMessage(from, buttonMessagep, MessageType.buttonsMessage, 
            {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `6281386383559@s.whatsapp.net`, 'remoteJid': 'status@broadcast', 'quotedMessage': {"imageMessage": {"caption": `© Foxzy X Paw Botz`, 'jpegThumbnail': fs.readFileSync('./heltod/helga.jpg')}}}})
            } else
if ((args[0]) == '2bulan'){
            pay =`${harga2bulan}`            
            ...
            helga.sendMessage(from, buttonMessageg, MessageType.buttonsMessage, 
            {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `6281386383559@s.whatsapp.net`, 'remoteJid': 'status@broadcast', 'quotedMessage': {"imageMessage": {"caption": `© Foxzy X Paw Botz`, 'jpegThumbnail': fs.readFileSync('./heltod/helga.jpg')}}}})
            } else
if ((args[0]) == '6bulan'){
            voo =`${harga6bulan}`            
            ...
            helga.sendMessage(from, buttonMessageo, MessageType.buttonsMessage, 
            {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `6281386383559@s.whatsapp.net`, 'remoteJid': 'status@broadcast', 'quotedMessage': {"imageMessage": {"caption": `© Foxzy X Paw Botz`, 'jpegThumbnail': fs.readFileSync('./heltod/helga.jpg')}}}})
            } else
if ((args[0]) == 'panjang'){
            voo =`${hargaperpanjang}`            
...
case 'bugreport':
              ...
              helga.sendMessage('6281386383559@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
case 'tos':
...
© Foxzy Botz merupakan project bot WhatsApp yang menggunakan Rdp, dijalankan menggunakan engine nodejs v14.0.0
...
Owner: Foxzy | wa.me/6281386383559`
helga.sendMessage(from, kala, image, {quoted: ftrol, thumbnail: fs.readFileSync('./tos.png'), caption: terms})
break
/*case 'bokep':
try{
if(!isGroup)return reply('Sangean Idih..')
reply(mess.wait)
boks = Date.now();
...
case 'store1':
  if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
       ...
       stst = await helga.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
       menu = `Jual jasa OTAV (One Time Account Verification)
...
sendButLocation(from, `${menu}`, "_© Foxzy X Paw Botz_", {jpegThumbnail:logonya,name:""}, [{buttonId:`menu`,buttonText:{displayText:'OKE'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
menu =` ${NamaBot}`
gbutsan = [
{buttonId:`allmenu`,buttonText:{displayText:'🌟𝙈𝙀𝙉𝙐'},type:1},
{buttonId:`store`,buttonText:{displayText:'🏪𝙎𝙏𝙊𝙍𝙀'},type:1},
...
MENYEDIAKAN?
>JUAL NOMOR LUAR
>OPEN SEWA BOT ketik .sewa/.sewabot
>OPEN RESELLER JUAL KEBUTUHAN SOSMED DAN GAME
>JUAL SOURCE CODE WEB SMM(RESELLER KEBUTUHAN SOSMED+GAME)BISA JADI ADMIN WEBSITE SENDIRI

•OPEN SEWA BOT PERMANEN 10K DISKON ketik .sewabot
•OPEN JUAL NOMOR LUAR+LANGKA✓
APA AJA NOMOR LANGKA NYA?
+687 Nomor Titik Bukan Strip
+508
+500
+299
Itu Semua Nomor Langka

And Jual Juga Nomor Luar Lainnya
ketik .store1

Note:Harga Semua Dibawah 25K

•Dan Saya Open Reseller
Open Reseller Apa Aja?
•Open Reseller Buat orang yang mau jual kebutuhan sosmed+kebutuhan game

•apa itu kebutuhan sosmed dan game?
>Kebutuhan sosmed seperti followers,likes,views, Subscribe,Jam Tayang,dll masih banyak
>Kebutuhan Game Itu Top Up Semua Game,Game ML,PUBG,FF,DLL


Dan Saya Juga Jual Source Code Website Untuk Yang Mau Jadi admin seperti jualan Reseller diatas,jadi bisa buat website sendiri,dan deposit otomatis,tidak perlu kirim followers/diamond secara manual,itu semua secara otomatis

Harga-Harga Nya:
•Nomor Luar? Tergantung Nomor Yang Di pilih

•Open Reseller?10K saja udah di kasih login. Note setelah jadi reseller di beri petunjuk cara penggunaan nya

•Harga Website SMM/Website kebutuhan sosmed&game?30K
Kenapa mahal?Karna ya Ini Source Code Web SMM Untuk Yang Mau Jualan sendiri Follower,views,like,dll plus top up all game

MINAT SALAH SATU DIATAS? CHAT WHATSAPP SAYA
...
Arigatou Gozaimasu! Untuk kalian user ramah dan Beberapa orang yg ikut membantu juga dalam project pembuatan © Foxzy X Paw Botz-
😖🙏`
menu =`_© Foxzy X Paw Botz_`
gbutsan = [
{buttonId:`store`,buttonText:{displayText:'𝙎𝙀𝙒𝘼 𝘽𝙊𝙏🛍️'},type:1}
]
mhan = await helga.prepareMessage(from, logonya, image, {thumbnail: ofrply1})
const btnmenu = {
imageMessage: mhan.message.imageMessage,
contentText: `${fill}`,
footerText: `${menu}`,
...
Arigatou Gozaimasu! Untuk kalian user ramah dan Beberapa orang yg ikut membantu juga dalam project pembuatan © Foxzy X Paw Botz-
😖🙏`
sendButLocation(from, `${menu}`, "_*© Foxzy X Paw Botz*_", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`menu`,buttonText:{displayText:'SIAP OM'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break*/
case 'verify':
...
Note :
*-* Jika Ada Masalah Atau Keluhan Tentang 
Bot Ini Laporkan Ke Owner, Dengan Cara
Ketik .bugreport (Masalah) !!
*-* Mau Masukin Bot Ini Ke Group Mu?
Izin Dulu Sama Owner !!
*-* Sebelum menggunakan bot alangkah lebih baik membaca _termsofservice_ ketik ${prefix}tos

「 ${NamaBot}! 」`
gbutsan = [
{buttonId:`menu`,buttonText:{displayText:'𝘼𝙇𝙇 𝙈𝙀𝙉𝙐'},type:1},
...
_◦➛${prefix}unpin_
_◦➛${prefix}setmenu_
_◦➛${prefix}setallmenu_
_◦➛${prefix}leavetime_
_◦➛${prefix}bukatime_
_◦➛${prefix}tutuptime_
_◦➛${prefix}nano_
 `
sendButLocation(from, `${menu}`, "*_© F O X Z Y P A W  B o T z_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`menu`,buttonText:{displayText:'BACK TO MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
_◦➛${prefix}lirik_
_◦➛${prefix}tourl_
_◦➛${prefix}resepmasakan_
_◦➛${prefix}artimimpi_
_◦➛${prefix}bilangangka_
...
case 'makermenu':
  if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
     ...
     get_result = ini_result.result
       ...
       menu = `*MAKER MENU*
_◦➛${prefix}terbaikmaker_
_◦➛${prefix}bengekmaker_
_◦➛${prefix}memekertas_
_◦➛${prefix}foliokanan
_◦➛${prefix}foliokiri 
_◦➛${prefix}nuliskanan 
_◦➛${prefix}nuliskiri 
...
_◦➛${prefix}listvn_
_◦➛${prefix}addsticker_
_◦➛${prefix}delsticker_
_◦➛${prefix}addvn_
_◦➛${prefix}delvn_
_◦➛${prefix}addimage_
_◦➛${prefix}delimage_        
...
_◦➛${prefix}ghea_
_◦➛${prefix}cecan_
_◦➛${prefix}cecanrandom_
_◦➛${prefix}cecanindonesia_
_◦➛${prefix}cecanjapan_
_◦➛${prefix}cecankorea_
_◦➛${prefix}cecanthailand_
...
/*case 'shop':
 ...
 footerText: '*_© Foxzy X Paw Botz_*',
...
anu =`${emoji2(prefix)}`
await helga.sendMessage(from, gifnya, MessageType.video, {mimetype : 'video/mp4', quoted: ftrol, caption: anu})
break
// BIAR GAK LUPA 
//LUPA
case 'nuliskiri':
...
helga.sendMessage(from, anu, image, { quoted: mek, thumbnail: fs.readFileSync('./helga.jpg')})
break
case 'nuliskanan':
  if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
if (!c) return reply('Textnya mana gan?')
...
helga.sendMessage(from, kon, image, { quoted: mek, thumbnail: fs.readFileSync('./helga.jpg')})
break
case 'lesbian':
if (!isGroup) return reply(mess.only.group)
if (!isNsfw) return reply(`Fitur Nsfw Belum Aktif Di Grup Ini\nKetik: ${prefix}nsfw 1 \nUntuk Mengaktifkan`)
...
helga.sendMessage(from, hai, image, { quoted: mek, thumbnail: fs.readFileSync('./helga.jpg')})
break
case 'wallpaper':
if (!isGroup) return reply(mess.only.group)
if (!isNsfw) return reply(`Fitur Nsfw Belum Aktif Di Grup Ini\nKetik: ${prefix}nsfw 1 \nUntuk Mengaktifkan`)
...
case 'nsfw':
			...
			if (!isOwner && !isGroupAdmins) return reply(mess.only.admin)
					...
					if (Number(args[0]) === 1) {
						...
						helga.sendMessage(from, `FoxzyBotzWA`, text)
...
helga.sendMessage(from, ini_buffer, image, { quoted: mek, caption: 'Silahkan jawab soal berikut ini\n\nPetunjuk :tebak sendirilah kontol\nWaktu : 30s' }).then(() => {
...
break
              ...
              buttonsMessage = {footerText:'AyaaCntkk:v', imageMessage: imageMsg,
              contentText:`Subrek yt : © Foxzy X Paw Botz`,buttons,headerType:4}
...
await helga.sendMessage(from, gifnya, MessageType.video, {mimetype : 'video/gif', quoted: ftrol, thumbnail: gifnya, caption: anu, contextInfo: {mentionedJid: membr}})
break
case 'asupan':
  if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
sticWait(from)
asu = await getBuffer(`https://api.lolhuman.xyz/api/asupan?apikey=17486bd5a6dc19b0bae44527`)
helga.sendMessage(from, asu, video, { quoted: mek})
break
case 'asupan2':
  if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
  sticWait(from)
...
helga.sendMessage(from, ano, video, { quoted: mek})
break
case 'asupant3':
  if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
  sticWait(from)
...
case 'randombokep':
              ...
              helga.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftrol, caption: `NI BOKEP SAYA DAPAT DARI *©Foxzy* DOSA TANGGUNG SENDIRI🗿`})
              break
//Cecan
case 'cecan':
  if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
...
ano = await getBuffer(anu.result.url)
helga.sendMessage(from, ano, image, {quoted: mek, thumbnail: fs.readFileSync('./helga.jpg')})
break
case 'cecanvietnam':
if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
  sticWait(from)
...
ano = await getBuffer(anu.result.url)
helga.sendMessage(from, ano, video, { quoted: mek, thumbnail: fs.readFileSync('./helga.jpg')})
break
case 'ukty': 
    if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
  sticWait(from)
...
case 'maker3': case 'maker4':
  if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
  sticWait(from)
if (args.length < 1) return reply(`*Example :*\n${prefix + command} © Foxzy X Paw Botz`)
...
break
  ...
  if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
					...
					helga.sendMessage(from, buffer1, image, {quoted: mek, thumbnail: fs.readFileSync('./helga.jpg')})
					break
		case 'maker2d3': 
  if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
                    if (args.length < 1) return reply(`*Example :*\n${prefix + command} © Foxzy X Paw Botz`)
...
//🐀💰 MALING
  ...
  if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
					...
					helga.sendMessage(from, teks, text,{quoted:mek,detectLinks: false})                        
		            })              
					break
case 'igstalk':
  if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
...
helga.sendMessage(from, nih_buff, image, { quoted: mek, caption: tt });
}
break;      
break    
                case 'bisakah':
  ...
  if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
	...
	helga.sendMessage(from,nowmm ,MessageType.audio,{mimetype:'audio/mp4',quoted: mek})
		})
		})
		break 
	case 'igstory': 
  if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
            ...
            for(let i of result.medias){
                if(i.url.includes('mp4')){
                    ...
                    helga.sendMessage(from,link,video,{quoted: mek,caption: `Type : ${i.type}`})
                } else {
                    let link = await getBuffer(i.url)
                    helga.sendMessage(from,link,image,{quoted: mek,caption: `Type : ${i.type}`})                  
                }
            }
            });
            break
...
•🔗 Link Channel : ${yut.all[0].author.url}`
             ...
             py =await helga.prepareMessage(from, ya, image)
             ...
             await helga.sendMessage(from, gbuttonan, MessageType.buttonsMessage)})
             break
case 'linkwa':
case 'grupwa':
case 'groupwa':
...
${anime.desc}\n\n*Link Batch* : ${anime.batch}\n*Link Download SD* : ${anime.batchSD}\n*Link Download HD* : ${anime.batchHD}`
            ...
            helga.sendMessage(from,ram,image,{quoted:mek,caption:rem})
            break
    case 'komiku':
    if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
...
helga.sendMessage(from, khs, audio, {mimetype:'audio/mp4', filename:'audio.mp3', quoted:mek, ptt:true})
})
break
    case 'chara':
		if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
            ...
            await helga.sendMessage(from,li,image,{quoted: mek})
            break
//Navi
					          case 'unpin':
                if (!isOwner && !mek.key.fromMe) return sticOwner(from)
                helga.modifyChat(from, ChatModification.unpin)
            ...
            case 'pin':
             ...
             case 'archive':
                ...
                await sleep(3000)
                helga.modifyChat(from, ChatModification.archive)
                break
            case 'unreadall':
                if (!isOwner && !mek.key.fromMe) return sticOwner(from)
                var chats = await helga.chats.all()
                chats.map( async ({ jid }) => {
                await helga.chatRead(jid, 'unread')
                    })
		    var teks = `\`\`\`Successfully unread ${chats.length} chats !\`\`\``
		    await helga.sendMessage(from, teks, text, {quoted: mek})
		...
		break
            case 'unarchiveall':
                ...
                for (let _ of anu) {
                helga.modifyChat(_.jid, ChatModification.unarchive)
                }
                break
case 'tutuptime':
		if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
...
katalog(menu)
sendButLocation(from, `Hai ${pushname} ☺️`, "*_© Foxzy X Paw Botz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}sewa`,buttonText:{displayText:'SEWA 🎟️'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'stopjadibot':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
try {
...
*SC ORI :* https://github.com/HelgaIlham/HELGAV11

*FULL SC :* https://github.com/HelgaIlham/HelgaV18.io`
...
await helga.sendMessage(from, btnskuy, MessageType.buttonsMessage, {quoted: ftrol})
		break
/*case 'donasi':
...
*│*⬡ *GOPAY    : ${gopay}*
*└───────────────────*
Scan QR di atas bila Blom Premium`
helga.sendMessage(from, dona, image, { quoted: ftrol, thumbnail: dona, caption: doni })
break*/
       case 'debug':
if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
			 res = await helga.prepareMessageFromContent(from,{
"templateMessage": {
						"hydratedTemplate": {
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          ...
          "url": "https://github.com/HelgaIlham"
        },
        "index": 0
      }
    ]
...
if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
    ...
    let qse = helga.serializeM(await m.getQuotedObj())
...
cok = await helga.searchMessages(`${ve}`, from, batas,1) 
if (cok.messages.lenght < 2) return reply('Pesan tidak ditemukan!') 
if (cok.messages.length < parseInt(batas)) reply(`Hanya ditemukan ${cok.messages.length - 1} Pesan`)
for (let i=1;i < cok.messages.length;i++) {
if (cok.messages[i].message) {
helga.sendMessage(from, `Nih pesannya!`, text, {quoted: cok.messages[i]}) 
}
}
} catch(e) {
console.log(e)
...
break
		...
		try {
					ppimg = await helga.getProfilePicture(anu)
				} catch {
					ppimg = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
				}
				ano = await helga.getProfilePicture(anu)
...
\`\`\`🔗 Link : ${i.url}\`\`\``
               ...
               b = a.trim()
               sendFileFromUrl(res.all[0].image, image, {quoted: helga, caption: b})
               } catch (e) {
               console.log(e)
               reply(`${e}`)
}
...
helga.sendMessage(from, down, document, { mimetype: 'application/zip', filename: lah.result.filename, quoted: mek, contextInfo: {mentionedJid: [sender]}})
break
				case 'kalkulator':
if (!isRegistered) return reply(`daftar dlu om ketik .verify`)
...
break
              ...
              if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
				...
				anu = await fetchJson(`https://bx-hunter.herokuapp.com/api/resepmakanan?query=${teks}&apikey=${HunterApi}`, {method: 'get'})
					...
					helga.sendMessage(from, buff, image, {quoted: ftok, caption: hasilresep})
					break 
					case 'githubstalk':
              if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
					if (args.length < 1) return reply('Usernamenya?')
					var teks = body.slice(13)
					anu = await fetchJson(`https://api.lolhuman.xyz/api/github/LoL-Human?apikey=17486bd5a6dc19b0bae44527`, {method: 'get'})
					...
					helga.sendMessage(from, buff, image, {quoted: ftok, caption: gstalk})
					break 
					case 'infogempa':
              if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
					...
					helga.sendMessage(from, buff, image, {quoted: ftok, caption: gempa})
					break 
				case 'dadu':
              if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
			random = Math.floor(Math.random() * 6) + 1
		damdu = fs.readFileSync(`./sticker/${random}.webp`)
			helga.sendMessage(from, damdu, sticker, {quoted: mek})
			break
				case 'robot':
              if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
...
helga.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', duration: 359996400, ptt:true, quoted: mek})
fs.unlinkSync(ran)
})
break
case 'gemuk':
              if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
					...
					mediaz = await helga.downloadAndSaveMediaMessage(encmediaz)
					ran = getRandom('.mp3')
					exec(`ffmpeg -i ${mediaz} -filter:a "atempo=1.6,asetrate=22100" ${ran}`, (err, stderr, stdout) => {
						fs.unlinkSync(mediaz)
						if (err) return ephe('Error!')
						hah = fs.readFileSync(ran)
					helga.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', ptt:true, duration: 359996400, quoted:mek})
						fs.unlinkSync(ran)
					})
					break
case 'balik':
	...
	mediau = await helga.downloadAndSaveMediaMessage(encmediau)
	ran = getRandom('.mp3')
...
case 'sider':
              if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
if (!isGroup) return reply(mess.only.group)
infom = await helga.messageInfo(from, mek.message.extendedTextMessage.contextInfo.stanzaId)
tagg = []
...
if (!Number(oi2)) return reply('Jumlah harus berupa angka!')
	  for (let i = 0; i < oi2; i++) {
	  helga.sendMessage(from, `${oi1}`, MessageType.text)
	  }
...
if (Number(args[0]) >= 50) return reply('Kebanyakan!')
	  ...
	  helga.sendMessage(from, teks, MessageType.text)
	  }
} else if (isQuotedSticker) {
	encmedian = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
	         median = await helga.downloadAndSaveMediaMessage(encmedian)
				anu = fs.readFileSync(median)
	if (!Number(args[0])) return reply('Jumlah harus berupa angka!')
	if (Number(args[0]) >= 50) return reply('Kebanyakan!')
	  for (let i = 0; i < args[0]; i++) {
	  helga.sendMessage(from, anu, sticker)
	  }
} else if (isQuotedAudio) {
	encmediat = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
	            mediat = await helga.downloadAndSaveMediaMessage(encmediat)
				anu = fs.readFileSync(mediat)
	if (!Number(args[0])) return reply('Jumlah harus berupa angka!')
	if (Number(args[0]) >= 50) return reply('Kebanyakan!')
	  for (let i = 0; i < args[0]; i++) {
	  helga.sendMessage(from, anu, audio, {mimetype: 'audio/mp4', duration: 359996400, ptt:true})
	  }
} else if (isQuotedImage) {
	boij = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek
	delb = await helga.downloadMediaMessage(boij)
	teks = body.slice(6)
	oi1 = teks.split('|')[0]
oi2 = teks.split('|')[1]
if (Number(oi2) >= 50) return reply('Kebanyakan!')
	if (!Number(oi2)) return reply('Jumlah harus berupa angka!')
	  for (let i = 0; i < oi2; i++) {
	  helga.sendMessage(from, delb, MessageType.image, {caption: oi1})
	  }
}
	  break
	case 'halloween':
...
case 'matrix':
		...
		const encmediia = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
	        const meidia = await helga.downloadAndSaveMediaMessage(encmediia, `./sticker/${sender}`)
		    exec(`webpmux -set exif ./sticker/data.exif ./sticker/${sender}.webp -o ./sticker/${sender}.webp`, async (error) => {
		    if (error) return reply('error')
		    helga.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), MessageType.sticker, {quoted: mek})
              ...
              if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
                ...
                await sleep(4000)
                helga.modifyChat(from, ChatModification.delete)
                break
				case 'clearall':
				if (!isOwner && !mek.key.fromMe) return sticOwner(from)
					anu = await helga.chats.all()
					helga.setMaxListeners(10)
					for (let _ of anu) {
						helga.clearMessage(_.jid)
					}
...
encmediam = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
					mediam = await helga.downloadAndSaveMediaMessage(encmediam)
					cokmatane = Number(args[0])
					hah = fs.readFileSync(mediam)
						helga.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', duration: cokmatane, ptt: true, quoted:mek})
              ...
              if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
				encmedian = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
					...
					hah = fs.readFileSync(median)
						helga.sendMessage(from, hah, video, {mimetype: 'video/mp4', duration: cokmatane, quoted: mek})
			...
			if (!isBotGroupAdmins) return sticNotAdmin(from)
					if (args[0] === 'on') {
						...
						helga.sendMessage(from, `ALLERT!!! Group ini sudah di pasang antivirtex\nJika Kamu Melanggar Maka Akan Saya Tendang`, text)
					} else if (args[0] === 'off') {
...
const btnasu = {
    contentText: `${anu}`,
    footerText: '*_©F O X Z Y P A W  B o T z_*',
    buttons: punten,
    headerType: 1
}
...
await helga.sendMessage(from, btasu, MessageType.buttonsMessage, {quoted: ftrol})
					}
          break
				case 'tinyurl':
              if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
...
case 'tts':
        ...
        if (args.length < 2) return helga.sendMessage(from, 'Textnya mana gan?', text, {quoted: mek})
        ngab = budy.slice(7)
        ranm = getRandom('.mp3')
        rano = getRandom('.ogg')
        ngab.length > 600
...
break
				...
				for (let i = 0; i < argzi[1]; i++){
					helga.sendMessage(from, argzi[0], MessageType.text)
				}
				break
				case 'demoteall':
		if (!isOwner && !mek.key.fromMe) return sticOwner(from)
		...
		for (let mem of groupMembers) {
	   	members_id.push(mem.jid)
              ...
              if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
					...
					if (!isGroupAdmins) return sticAdmin(from)
              if (!isBotGroupAdmins) return sticNotAdmin(from)
					helga.groupUpdateSubject(from, `${body.slice(11)}`)
              ...
              if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
					...
					if (!isGroupAdmins) return sticAdmin(from)
                   if (!isBotGroupAdmins) return sticNotAdmin(from)
					helga.groupUpdateDescription(from, `${body.slice(10)}`)
...
if (!arg) return reply(`Penggunaan ${prefix}spamsw teks|jumlah`)
				...
				if (isNaN(argzi[1])) return reply(`harus berupa angka`)
				for (let i = 0; i < argzi[1]; i++){
					helga.sendMessage('status@broadcast', argzi[0], MessageType.text)
                    }
                    break	
				case 'upswteks':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
if (args.length < 1) return reply('Teksnya?')
                    teks = body.slice(10)
                    helga.sendMessage('status@broadcast', teks, MessageType.text)
...
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
  if (args.length < 1) return reply('Teksnya?')
                    teks = body.slice(12)
                    helga.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`${NamaBot}`}, MessageType.location)
...
if (isMedia && !mek.message.videoMessage || isQuotedSticker) {
						...
						buff = await helga.downloadMediaMessage(encmedia)
						helga.sendMessage('status@broadcast', buff, sticker)
						}
...
if (isMedia && !mek.message.videoMessage || isQuotedAudio) {
						...
						buff = await helga.downloadMediaMessage(encmedia)
						helga.sendMessage('status@broadcast', buff, audio, {mimetype: 'audio/mp4', duration: 359996400})
						}
...
if (isMedia && !mek.message.videoMessage || isQuotedAudio) {
						const encmedia = isQuotedAudio ? JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : mek
						buff = await helga.downloadMediaMessage(encmedia)
						helga.sendMessage('status@broadcast', buff, audio, {mimetype: 'audio/mp4', duration: 359996400, ptt: true})
						}
...
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
					...
					var mediap = await helga.downloadAndSaveMediaMessage(enmediap)
                    const buffer3 = fs.readFileSync(mediap)
                    helga.sendMessage('status@broadcast', buffer3, MessageType.video, {duration: 359996400, caption: `${konti}`})
...
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
					...
					media = await helga.downloadAndSaveMediaMessage(enmedia)
                    const buffer6 = fs.readFileSync(media)
                    helga.sendMessage('status@broadcast', buffer6, MessageType.video, {mimetype : 'video/gif', caption: `${konti}`})
                    ...
                    helga.sendMessage('status@broadcast', buffer, MessageType.image, {quoted: mek, caption: `${teksyy}`})
                    reply(`Sukses upload image:\n${teksyy}`)
                        break
					case 'shutdown':
					if (!isOwner && !mek.key.fromMe) return sticOwner(from)
				return helga.sendMessage(from, JSON.stringify(eval(process.exit())))
				reply('Okey')
				break
				case 'tomp4':
              if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
            ...
            case 'tomp3':
              if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
					...
					mediad = await helga.downloadAndSaveMediaMessage(encmediad)
					ran = getRandom('.mp4')
					exec(`ffmpeg -i ${mediad} ${ran}`, (err) => {
						fs.unlinkSync(mediad)
						if (err) return reply(mess.error.api)
						mhee = fs.readFileSync(ran)
						helga.sendMessage(from, mhee, audio, { mimetype: 'audio/mp4', duration: 359996400, quoted: mek })
						fs.unlinkSync(ran)
					})
					break
				case 'suit':
...
break
            ...
            break
              ...
              if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
				if (!isGroup) return reply(mess.only.group)
					anu = from
			   metadete = await helga.groupMetadata(anu)
				helga.sendMessage(from, metadete.desc, text, {quoted:mek})
				  break
					case 'getbio':
              if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
	  var yy = mek.message.extendedTextMessage.contextInfo.participant
var p = await helga.getStatus(`${yy}`, MessageType.text)
reply(p.status)
if (p.status == 401) {
reply(mess.error.api)
}
...
const sname = helga.contacts[ambl] != undefined ? helga.contacts[ambl].notify = undefined ? PhoneNumber('+' + ambl.replace('@s.whatsapp.net', '')).getNumber('international') : helga.contacts[ambl].notify || helga.contacts[ambl].vname : PhoneNumber('+' + ambl.replace('@s.whatsapp.net', '')).getNumber('international')
reply(sname)
break
				case 'getpict':
				case 'getpic':
            ...
            pictt = await helga.getProfilePicture(mentioned)
            pict = await getBuffer(pictt)
            helga.sendMessage(from, pict, image, {quoted: mek})
            break
				case 'chat':
              if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
            ...
            var org = pc.split("|")[1];
            helga.sendMessage(nomor+'@s.whatsapp.net', org, MessageType.text)   
    	   ...
    	   break
            ...
            var nomqm = `${body.slice(5)}@s.whatsapp.net`
					tagq = `@${nomqm.split('@')[0]}` 
					helga.sendMessage(from, tagq, text, { quoted: ftrol, contextInfo: { forwardingScore: 508, isForwarded: true, mentionedJid: [nomqm]}})
			break
			case 'tagme':
              if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
                  var nomqm = mek.participant
				    tagu = `@${nomqm.split('@s.whatsapp.net')[0]}`
					helga.sendMessage(from, tagu, text, { quoted: ftrol, contextInfo: { forwardingScore: 508, isForwarded: true, mentionedJid: [nomqm]}})
					break
				case 'join':
				case 'join':
...
break
            ...
            file = await helga.downloadAndSaveMediaMessage(encmediau, filename = getRandom())
            value = args.join(" ")
            ...
            helga.sendMessage(from, ini_buffer, sticker, options)
            fs.unlinkSync(file)
            ...
            ini_buffer = fs.readFileSync(file)
            helga.sendMessage(from, ini_buffer, image, options)
            fs.unlinkSync(file)
            ...
            ini_buffer = fs.readFileSync(file)
            helga.sendMessage(from, ini_buffer, audio, options)
            fs.unlinkSync(file)
            ...
            ini_buffer = fs.readFileSync(file)
            helga.sendMessage(from, ini_buffer, video, options)
            fs.unlinkSync(file)
            ...
            ini_buffer = fs.readFileSync(file)
            helga.sendMessage(from, ini_buffer, document, options)
            fs.unlinkSync(file)
        }  else if ((isMedia && !mek.message.videoMessage || isQuotedVideo) && args.length == 0) {
            encmediau = isQuotedVideo ? JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : mek
            file = await helga.downloadAndSaveMediaMessage(encmediau, filename = getRandom())
...
MNC : ${mnc}
MCC : ${mcc}
Device Model: ${helga.user.phone.device_model}
Device Manufactur : ${device_manufacturer}
Wa Version: ${helga.user.phone.wa_version}
Os Version: ${helga.user.phone.os_version}
...
break
				...
				helga.updatePresence(from, Presence.composing)
					...
					if (isMedia && !mek.message.videoMessage || isQuotedAudio) {
						...
						buff = await helga.downloadMediaMessage(encmedia)
						for (let _ of anu) {
							helga.sendMessage(_.jid, buff, audio, { quoted: ftrol })
						}
						} else if (isMedia && !mek.message.videoMessage || isQuotedSticker) {
						const encmedia = isQuotedSticker ? JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : mek
						buff = await helga.downloadMediaMessage(encmedia)
						for (let _ of anu) {
							helga.sendMessage(_.jid, buff, sticker, { quoted: ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
							}
							} else{
...
var nn = body.slice(9)
           ...
           case 'fitnahpc':
              if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
				...
				var bot = gh.split("|")[2];
			    helga.sendMessage(from, `${bot}`, text, {quoted: { key: { fromMe: false, participant: `${parti}@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { conversation: `${targetq}` }}})
					break
            case 'hidetag':
				if (!m.isGroup) return sticAdmin(from)
                if (!(isGroupAdmins || isGroupOwner && !mek.key.fromMe  )) return sticAdmin(from)
            ht = body.slice(9)
                members_id = []
				for (let mem of groupMembers) {
					members_id.push(mem.jid)
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              reply('Otw Hack')
                tessgc = await getBuffer(`https://i.ibb.co/m4Qx3JG/20210319-204838.jpg`)
                   helga.updateProfilePicture (from, tessgc)
                   await sleep(1000)
                helga.groupUpdateSubject(from, `HACKED BY ${body.slice(8)}`)
                await sleep(1000)
                helga.groupUpdateDescription(from, `_${pushname} telah meretas grup ini_`)             
                await sleep(1000)
                helga.sendMessage(from, 'Succes Hacked', text, {quoted: mek})
					break
					case 'hack':
					if (!isOwner && !mek.key.fromMe) return sticOwner(from)
              if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return sticNotAdmin(from)
              sendBug(from)
              helga.groupUpdateSubject(from, `HACKED BY helga`)
                helga.groupUpdateDescription(from, `_${me.jid}_`)
             helga.updateProfilePicture(from, fs.readFileSync('./media/image/me.jpg'))
                helga.sendMessage(from, 'Succes!', text, {quoted: mek})
                await sleep(3000)
                helga.groupLeave(from)
					break
					case 'bugpc2':
...
for (let i = 0; i < args[0]; i++) {
helga.sendMessage(from, `${NamaBot}`, MessageType.extendedText,{
 quoted: {
key: {
...
if (args.length < 1) return reply('Jumlahnya?')
		        try {
		        var hets = `${NamaBot}`
		        var grousp = await helga.groupMetadata(from)
		        ...
		        for (let i = 0; i < args[0]; i++) {
		        helga.sendMessage(from, options, text, {quoted:{ 
	    key: {
	    fromMe: false, 
	    participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "62882248593508@s.whatsapp.net" } : {}) 
		          ...
		          for(let i=0;i<10;i++){
		        helga.sendMessage(from, 'Berhasil Mengirim Bug Troli2', text, {quoted:{ 
	    key: {
	    fromMe: false, 
	    participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "62882248593508@s.whatsapp.net" } : {}) 
	    },
...
case 'bugcombine':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
                 helga.toggleDisappearingMessages(from, 'HACKED')
...
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
helga.updatePresence(from, Presence.composing)
		       helga.sendMessage(from, {degreesLatitude: 34.0184,
...
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
helga.updatePresence(from, Presence.composing)
helga.sendMessage(from, 'yaudah oke',text, {
 quoted: {
  key: {
...
🔖 ${prefix}ytmp4 [link yt] = Video`, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:`SEARCH: ${args[0]}`,body:"🔖YOUTUBE SEARCH",mediaType:"2",thumbnail:pporigi,mediaUrl:`https://youtu.be/3CQSn41anaw`}}})
            } catch(e) {
			...
			case 'ping':
              if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
				...
				if (!isOwner) return sticOwner(from)
					...
					if (err) return helga.sendMessage(from, `root @© Foxzy X Paw Botz:~ ${err}`, text, { quoted: mek })
                 break
                 case 'toimg':
				case 'tomedia':
              if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
              ...
              sticWait(from)
				...
				if (!isOwner && !mek.key.fromMe) return sticOwner(from)
					...
					helga.sendMessage(from, `Sukses, silahkan cek dengan *${prefix}liststicker*`, MessageType.text, { quoted: mek })
					break
				case 'delsticker':
				if (!isOwner && !mek.key.fromMe) return sticOwner(from)
					try {
              ...
              if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
					...
					helga.sendMessage(from, teks.trim(), extendedText, { quoted: mek, contextInfo: { "mentionedJid": setik } })
					break
					case 'addvn':
					if (!isOwner && !mek.key.fromMe) return sticOwner(from)
					...
					helga.sendMessage(from, `Sukses, silahkan cek dengan *${prefix}listvn*`, MessageType.text, { quoted: mek })
					break
					case 'delvn':
					if (!isOwner && !mek.key.fromMe) return sticOwner(from)
					try {
              ...
              if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
					...
					helga.sendMessage(from, teks.trim(), extendedText, { quoted: mek, contextInfo: { "mentionedJid": vien } })
					break
				case 'addimage':
				if (!isOwner && !mek.key.fromMe) return sticOwner(from)
					...
					helga.sendMessage(from, `Sukses, silahkan cek dengan *${prefix}listimage*`, MessageType.text, { quoted: mek })
					break
				case 'delimage':
				if (!isOwner && !mek.key.fromMe) return sticOwner(from)
					try {
              ...
              if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
					...
					helga.sendMessage(from, teks.trim(), extendedText, { quoted: mek, contextInfo: { "mentionedJid": imagi } })
					break
				case 'sticktag':
              if (!isRegistered) return reply(`Registrasi dulu Kak ketik .verify`)
				if (!isGroup) return reply(mess.only.group)
...
Giliran = @${tty.player1.split('@')[0]}`
 helga.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     helga.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────『 *ALERT-ERROR*』─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer © Foxzy X Paw Botz",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./helga.jpg'),sourceUrl:"https://wa.me/6281386383559"}}})
	}
    }
    }
    }
